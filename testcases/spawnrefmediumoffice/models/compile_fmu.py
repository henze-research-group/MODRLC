...
# Increase memory
pymodelica.environ['JVM_ARGS'] = '-Xmx10000m'
...
# DEFINE MODEL
# ------------
mopath = 'SpawnReferenceMediumOffice.mo';
modelpath = 'SpawnReferenceMediumOffice'
# ------------
...
#fmu_name = compile_fmu(model, 'SpawnReferenceMediumOffice.mo',
#                       version="2.0",
