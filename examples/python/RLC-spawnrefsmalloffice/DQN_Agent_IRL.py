...
class DQN_Agent:
    def __init__(self,state_size,action_size):
        ...
        self.memory = deque(maxlen=288*70)
        self.target_model = self.build_model()
        self.epsilon = 0.65 # initial exploration
        self.epsilon_decay = 0.995
        self.train_start =24
        self.batch_size = 288*2
        self.discount_factor = 0.9
        self.epsilon_min = 0.03  # min exploration at the end
    ...
    def train_model(self):
        ...
        history = self.model.fit(np.array(states),np.array(targets_f),epochs=6,verbose=1)
