...
class ValueNetwork(nn.Module):
    ...
    def forward(self, state):
        # print ("state in for : {}".format(state))
...
class PolicyNetwork(nn.Module):
    ...
    def forward(self, state):
        ...
        # print ("mean in forward: {}".format(mean))
        log_std = entropy * self.log_std_linear(x)
    ...
    def get_action(self, state):
        ...
        # print ("z: {}; std: {}, std*z: {}".format(z,std,std*z))
...
class Agent:
    def __init__(self, action_dim, state_dim, hidden_dim,replay_buffer_size,path):
        ...
        self.value_lr  = 0.0006
        self.soft_q_lr = 0.0006
        self.policy_lr = 0.0006

        # self.value_lr  = 0.0000005
        # self.soft_q_lr = 0.0000005
    ...
    def train(self,batch_size,epochs,gamma=0.9995,soft_tau=0.00015):  
        q_value_loss1_l = []
        q_value_loss2_l = []
        value_loss_l = []
        policy_loss_l = []
        for i in range(epochs):
            ...
            # print ("Next State: {}".format(next_state.shape))
            # print ();print ()
