...
class GymEnv(gym.Env):
     def __init__(self,                 
          ...
          self.t_model.load_weights(path_NN+"t_model.h5")
          ...
          self.lighting_model.load_weights(path_NN+"lighting_model.h5")
          self.appliances_model.load_weights(path_NN+"appliances_model.h5")
     ...
     def step(self,action):  
          ...
          X_t_n = np.array([normalize_t_state(full_row)]) 
          ...
          lighting_pow = pred_lighting_model[0][0]* min_max["elec_equip"][1]
          appliances_pow = pred_appliances_model[0][0] * min_max["elec_lights"][1]

          pred_t_model= self.t_model.predict(X_t_n,verbose=0)[0]
          ...
          hvac_pow = (pred_t_model[1]/scale_hvac* min_max["hvac_dem_tot"][1])
          ...
          self.reward = self.compute_reward(flag)
          info = self.get_info() 
