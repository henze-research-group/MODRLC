...
def template_mpc(model):
    ...
    mpc.set_rterm(fake_heating_power=1e-4) # cooling_power=1e-4) fan_power=1e-4,
    ...
    mpc.bounds['lower', '_u', 'fake_heating_power'] = mp.min_heating
    mpc.bounds['upper', '_u', 'fake_heating_power'] = mp.max_heating
