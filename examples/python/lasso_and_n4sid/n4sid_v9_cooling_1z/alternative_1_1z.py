...
train_date_start = test_date_start - datetime.timedelta(days=67)
...
## Definition of the Inputs Vector. Training dataset
    ...
    list_of_vars = [
        'T_OA','HgloHor1','P1_IntGaiTot','P1_CooPow','P1_OAVol','P1_FanVol',
#        'T_OA', 'HgloHor1', 'P1_OccN', 'P1_IntGaiTot', 'P1_CooPow', 'P1_FanPow', 'P1_OAVol',
...
#
    method = 'N4SID'
    sys_id1 = system_identification(y_tot1, U_1, method, SS_fixed_order=8) #IC='AICc')

    #print(sys_id1)
    #SS_fixed_order=7
    #    SS_fixed_order=5
#    sys_id1.x2=np.array([[-6.43654287],
#       [ 6.21475534],
#       [ 0.48427129],
#       [-0.29315051],
#       [ 2.92122395],
...
#    Results of Temperature estimation of zone 1
 ...
 #    mape_z1= mean_absolute_percentage_error(y_tot1_test[1,0:t_2-t_1],yid1_test[1,0:t_2-t_1]);
    ...
    print(mae_z1)
    print("Mean Square Errors: ")
    print(mse_z1)#    plt.text(1, 10, "R2=",r2_core,size=18)
#    plt.yticks(size=16)
#    plt.xticks(size=10)
