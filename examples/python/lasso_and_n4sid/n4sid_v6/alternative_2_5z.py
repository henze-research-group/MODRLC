...
## Definition of the Inputs Vector. Training dataset
    ...
    U1=[
        ...
        (df1['Coo_term_core']-df1['Core_T']).values.tolist(),
        (df1['Inf_term_core']+df1['Core_T']).values.tolist(),
        #df1['Core_QconFlow'].values.tolist(),
        df1['Core_OccN'].values.tolist(),
        df1['CORE_IntGaiTot'].values.tolist(),
        

        (df1['Hea_term_P1']+df1['P1_T']).values.tolist(),
        (df1['Coo_term_P1']-df1['P1_T']).values.tolist(),
        (df1['Inf_term_P1']+df1['P1_T']).values.tolist(),
        #df1['P1_QconFlow'].values.tolist(),
        df1['P1_OccN'].values.tolist(),
        df1['P1_IntGaiTot'].values.tolist(),
        
        (df1['Hea_term_P2']+df1['P2_T']).values.tolist(),
        (df1['Coo_term_P2']-df1['P2_T']).values.tolist(),
        (df1['Inf_term_P2']+df1['P2_T']).values.tolist(),
        #df1['P2_QconFlow'].values.tolist(),
        df1['P2_OccN'].values.tolist(),
        df1['P2_IntGaiTot'].values.tolist(),

        (df1['Hea_term_P3']+df1['P3_T']).values.tolist(),
        (df1['Coo_term_P3']-df1['P3_T']).values.tolist(),
        (df1['Inf_term_P3']+df1['P3_T']).values.tolist(),
        #df1['P3_QconFlow'].values.tolist(),
        df1['P3_OccN'].values.tolist(),
        df1['P3_IntGaiTot'].values.tolist(),
        
        
        (df1['Hea_term_P4']+df1['P4_T']).values.tolist(),
        (df1['Coo_term_P4']-df1['P4_T']).values.tolist(),
        (df1['Inf_term_P4']+df1['P4_T']).values.tolist(),
        #df1['P4_QconFlow'].values.tolist(),
        df1['P4_OccN'].values.tolist(),  
        df1['P4_IntGaiTot'].values.tolist()
        ]
...
#    
    ...
    U1_test=[
        ...
        (df1_test['Hea_term_core']+df1_test['Core_T']).values.tolist(),
        (df1_test['Coo_term_core']-df1_test['Core_T']).values.tolist(),
        (df1_test['Inf_term_core']+df1_test['Core_T']).values.tolist(),
        #df1_test['Core_QconFlow'].values.tolist(),
        df1_test['Core_OccN'].values.tolist(),
        df1_test['CORE_IntGaiTot'].values.tolist(),
        

        (df1_test['Hea_term_P1']+df1_test['P1_T']).values.tolist(),
        (df1_test['Coo_term_P1']-df1_test['P1_T']).values.tolist(),
        (df1_test['Inf_term_P1']+df1_test['P1_T']).values.tolist(),
        #df1_test['P1_QconFlow'].values.tolist(),
        df1_test['P1_OccN'].values.tolist(),
        df1_test['P1_IntGaiTot'].values.tolist(),
        
        (df1_test['Hea_term_P2']+df1_test['P2_T']).values.tolist(),
        (df1_test['Coo_term_P2']-df1_test['P2_T']).values.tolist(),
        (df1_test['Inf_term_P2']+df1_test['P2_T']).values.tolist(),
        #df1_test['P2_QconFlow'].values.tolist(),
        df1_test['P2_OccN'].values.tolist(),
        df1_test['P2_IntGaiTot'].values.tolist(),

        (df1_test['Hea_term_P3']+df1_test['P3_T']).values.tolist(),
        (df1_test['Coo_term_P3']-df1_test['P3_T']).values.tolist(),
        (df1_test['Inf_term_P3']+df1_test['P3_T']).values.tolist(),
        #df1_test['P3_QconFlow'].values.tolist(),
        df1_test['P3_OccN'].values.tolist(),
        df1_test['P3_IntGaiTot'].values.tolist(),
        
        
        (df1_test['Hea_term_P4']+df1_test['P4_T']).values.tolist(),
        (df1_test['Coo_term_P4']-df1_test['P4_T']).values.tolist(),
        (df1_test['Inf_term_P4']+df1_test['P4_T']).values.tolist(),
        #df1_test['P4_QconFlow'].values.tolist(),
        df1_test['P4_OccN'].values.tolist(),  
        df1_test['P4_IntGaiTot'].values.tolist()  
...
##
    y_tot1= [df1['Core_T'].values.tolist(),df1['P1_T'].values.tolist(),df1['P2_T'].values.tolist(),df1['P3_T'].values.tolist(),df1['P4_T'].values.tolist()]
...
##
    y_tot1_test= [df1_test['Core_T'].values.tolist(),df1_test['P1_T'].values.tolist(),df1_test['P2_T'].values.tolist(),df1_test['P3_T'].values.tolist(),df1_test['P4_T'].values.tolist()]
...
#            
    method = 'N4SID'
    sys_id1 = system_identification(y_tot1, U_1, method, IC='AICc')#SS_fixed_order=3)#IC='AICc')
