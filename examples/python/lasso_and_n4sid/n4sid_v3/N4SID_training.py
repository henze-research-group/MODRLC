...
#    df1_test['P1_IntGaiTot'].shift(periods=1, fill_value=0).values.tolist(),
    ...
    method = 'N4SID'
    sys_id1 = system_identification(y_tot1, U_1, method, SS_fixed_order=3)#IC='AIC')#
...
#    sys_id1.x1=np.array([[a],[b],[c],[d],[e],[f],[g],[h],[i],[l],[n],[o],[q]])  
    ...
    xid1_test, yid1_test = fsetSIM.SS_lsim_predictor_form(sys_id1.A_K, sys_id1.B_K, sys_id1.C, sys_id1.D, sys_id1.K, yid1_train, U_1_test,sys_id1.x1)
